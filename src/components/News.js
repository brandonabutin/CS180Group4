...
class News extends Component {
  ...
  componentDidMount() {
    axios.get('https://newsapi.org/v2/everything?q=bitcoin&from=2019-11-11&sortBy=publishedAt&apiKey=d371789835b74790872200863148cf78')
      .then(res => {
        const newsArticles = res.data['articles']
        console.log(newsArticles)
        this.setState({currency: newsArticles})
      })
      /*
    fetch('https://newsapi.org/v2/everything?q=bitcoin&from=2019-10-05&sortBy=publishedAt&apiKey=API_KEY')
      .then(response => {
  ...
  render() {
    ...
    return (
      ...
      <div className="App">
        ...
        <Table2 data={this.state.currency}/>
      </div>
